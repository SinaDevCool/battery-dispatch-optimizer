...
from backend.db.repositories.business_decision_repository import (
    get_latest_business_decision,
    list_business_decisions,
    save_business_decision,
)
from backend.db.repositories.revenue_repository import get_revenue_stack_run
from backend.db.repositories.signal_repository import get_signal_run, list_signal_runs
from backend.hedging.revenue_contracts import build_hedged_revenue_view
from backend.markets.products.product_registry import build_asset_product_eligibility_list
...
def load_latest_revenue_stack_payload(asset_id):
    from backend.db.repositories.revenue_repository import list_revenue_stack_runs
