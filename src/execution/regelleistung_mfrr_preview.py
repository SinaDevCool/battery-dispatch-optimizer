...
from src.execution.market_adapters.regelleistung_mfrr import (
...
def build_latest_regelleistung_mfrr_preview(asset_id):
    ...
    preview = build_regelleistung_mfrr_preview(
        asset=asset,
        telemetry=telemetry,
    )
...
def latest_regelleistung_mfrr_preview(asset_id):
    return {
        "status": "ok",
        "asset_id": asset_id,
        "preview": build_latest_regelleistung_mfrr_preview(asset_id),
    }
