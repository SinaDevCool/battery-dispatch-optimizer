...
from src.execution.market_adapters.regelleistung_afrr import (
...
def build_latest_regelleistung_afrr_preview(asset_id):
    ...
    preview = build_regelleistung_afrr_preview(
        asset=asset,
        telemetry=telemetry,
    )
...
def latest_regelleistung_afrr_preview(asset_id):
    return {
        "status": "ok",
        "asset_id": asset_id,
        "preview": build_latest_regelleistung_afrr_preview(asset_id),
    }
