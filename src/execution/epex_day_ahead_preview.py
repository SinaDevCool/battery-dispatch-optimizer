...
from src.execution.market_adapters.epex_day_ahead import (
...
def build_latest_epex_day_ahead_preview(asset_id):
    ...
    preview = build_epex_day_ahead_preview(bids=bids)
...
def latest_epex_day_ahead_preview(asset_id):
    return {
        "status": "ok",
        "asset_id": asset_id,
        "preview": build_latest_epex_day_ahead_preview(asset_id),
    }
