...
from dashboard.sections.settings.battery_config import render_battery_config_section
from dashboard.sections.settings.client_identity import (
    render_client_identity_section,
)
from dashboard.sections.settings.commercial_config import (
    render_commercial_config_section,
)
from dashboard.sections.settings.presets import render_client_presets_section
from dashboard.sections.settings.save_config import render_save_client_config_section
from dashboard.sections.settings.strategy_config import render_strategy_config_section
